...
export const settingProps = (
  ...
  const startupFilter = rangeScope
    ? (getInitRange(startRange, weekStartDay, yearStartMonth, rangeScope) as
        | dateRange
        | undefined)
    : undefined;
  ...
  return {
    ...
    contentAlignment: String(display.contentAlignment.value),
    ...
    fontBold: style.font.bold?.value ?? false,
    fontItalic: style.font.italic?.value ?? false,
  };
};
